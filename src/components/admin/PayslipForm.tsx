...
export default function PayslipForm({ employees }: PayslipFormProps) {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      // Chromium PDF is stored briefly, then downloaded via a normal GET URL.
      if (contentType.includes('application/json')) {
        ...
        // Same-origin GET with Content-Disposition: attachment (not a JS blob).
      ...
      throw new Error('Unexpected response from payslip API')
    } catch (err) {
    ...
    <section className="bg-white border border-slate-200 rounded-2xl p-5 sm:p-6">
      <div className="mb-4">
        ...
        <p className="text-sm text-slate-500">
          ...
          Special Allowance 28%, Travel 7%. Deductions stay empty. Portrait A4 PDF is generated by Chromium.
        </p>
      </div>
