...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================
    const tiltCards = document.querySelectorAll('.service-card, .value-card, .mission-card, .contact-info-card');
    ...
    tiltCards.forEach(card => {
        card.addEventListener('mousemove', (e) => {
            ...
            card.style.background = `radial-gradient(circle at ${glowX}% ${glowY}%, rgba(10, 186, 181, 0.06) 0%, transparent 60%), var(--white)`;
        });
